...
public sealed class QueryMethodRegistry
{
        ...
        IFireworksConsoleBalanceReader? fireworks = null)
    {
        var methods = new List<IQueryMethod>
        {
            ...
            new MiniMaxTokenPlanMethod(),
            new OpenRouterKeyMethod(),
            new OpenRouterKeyMethod(cost: true),
            new OpenRouterCreditsMethod(),
            new OrganizationUsageMethod(anthropic: false, cost: false),
            new OrganizationUsageMethod(anthropic: false, cost: true),
            new OrganizationUsageMethod(anthropic: true, cost: false),
            new OrganizationUsageMethod(anthropic: true, cost: true),
